...
for CURR_YEAR in $(seq ${START_YEAR} ${END_YEAR}); do
  ...
  sync_dir "./gnss/products/ionex/" "/gnss/products/ionex/${CURR_YEAR}/"  "${DOY}/COD0OPSFIN_${YYYY}${DOY}0000_01D_01H_GIM.INX.gz ${DOY}/COD0OPSRAP_${YYYY}${DOY}0000_01D_01H_GIM.INX.gz ${DOY}/COD0OPSP1D_${YYYY}${DOY}0000_01D_01H_GIM.INX.gz ${DOY}/c2pg${DOY}0.${YY}i.Z"
